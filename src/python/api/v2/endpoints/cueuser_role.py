...
from v2.utils.cueuser_role import (
...
async def associate_cueuser_with_role_endpoint(data: CueuserRoleCreate, ):
    try:
...
async def dissociate_cueuser_from_role_endpoint(data: CueuserRoleCreate, ):
    try:
...
async def list_roles_for_cueuser_endpoint(cueuser_id: UUID, ):
    try:
...
async def list_cueusers_with_role_endpoint(role_id: UUID, ):
    try:
