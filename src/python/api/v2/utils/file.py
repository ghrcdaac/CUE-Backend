...
async def get_file_details(file_id: UUID) -> Dict[str, Any]:
...
async def list_files(ngroup_id: UUID, page: int, page_size: int) -> Tuple[List[Dict[str, Any]], int]:
...
async def update_file(file_id: UUID, file_update: FileUpdateRequest) -> Dict[str, Any]:
