# ==============================================================================
# File: src/python/api/v2/utils/role.py (Final)
# Purpose: Contains the business logic for role management.
# ==============================================================================
...
async def get_role(role_id: UUID) -> Dict[str, Any]:
...
async def get_role_by_lookup(short_name: Optional[str], long_name: Optional[str]) -> Dict[str, Any]:
...
async def update_role(role_id: UUID, role_update: RoleUpdate) -> Dict[str, Any]:
