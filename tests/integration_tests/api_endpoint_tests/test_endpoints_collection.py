...
@pytest.mark.asyncio
async def test_create_collection_endpoint_bad_requests(test_client, test_admin_user, test_daac_manager_user, seed_provider, seed_egress, seed_ngroup, test_provider, test_egress, make_jwt):
...
def test_list_collection_endpoint_no_active_ngroup(test_client, test_admin_user, test_daac_manager_user, test_provider, test_egress, make_jwt):
    test_admin_user_jwt = make_jwt(sub=str(test_admin_user.id),
                                   active_ngroup_id=test_admin_user.active_ngroup_id,
                                   roles=test_admin_user.roles,
                                   ngroups=test_admin_user.ngroups)
...
def test_get_collection_endpoint_does_not_exists(test_client, test_admin_user, test_provider, test_egress, make_jwt):
    test_admin_user_jwt = make_jwt(sub=str(test_admin_user.id),
                                   active_ngroup_id=test_admin_user.active_ngroup_id,
                                   roles=test_admin_user.roles,
                                   ngroups=test_admin_user.ngroups)
...
@pytest.mark.asyncio
async def test_get_collection_endpoint_non_access(test_client, test_admin_user, test_daac_manager_user, seed_provider, seed_egress, seed_ngroup, make_jwt):
...
def test_update_collection_endpoint_not_found(test_client, test_admin_user, test_provider, test_egress, make_jwt):
    test_admin_user_jwt = make_jwt(sub=str(test_admin_user.id),
                                   active_ngroup_id=test_admin_user.active_ngroup_id,
                                   roles=test_admin_user.roles,
                                   ngroups=test_admin_user.ngroups)
...
@pytest.mark.asyncio
async def test_update_collection_endpoint_non_access(test_client, test_admin_user, test_daac_manager_user, seed_provider, seed_egress, seed_ngroup, make_jwt):
    ngroup2_id = uuid.uuid4()
    ngroup2 = await seed_ngroup(ngroup2_id, "test_ngroup2", "Test Ngroup 2")
    egress2 = await seed_egress("s3", "/data", {"destination_path":"/sub_folder"}, ngroup2["id"])
    provider2 = await seed_provider("test_ngroup_2_provider", "Test Ngroup 2 Provider", True, test_admin_user.id, ngroup_id=ngroup2["id"])
...
def test_delete_collection_endpoint_not_found(test_client, test_admin_user, test_provider, test_egress, make_jwt):
    test_admin_user_jwt = make_jwt(sub=str(test_admin_user.id),
                                   active_ngroup_id=test_admin_user.active_ngroup_id,
                                   roles=test_admin_user.roles,
                                   ngroups=test_admin_user.ngroups)
...
@pytest.mark.asyncio
async def test_delete_collection_endpoint_non_access(test_client, test_admin_user, test_daac_manager_user, seed_provider, seed_egress, seed_ngroup, make_jwt):
    ngroup2_id = uuid.uuid4()
    ngroup2 = await seed_ngroup(ngroup2_id, "test_ngroup2", "Test Ngroup 2")
    egress2 = await seed_egress("s3", "/data", {"destination_path":"/sub_folder"}, ngroup2["id"])
    provider2 = await seed_provider("test_ngroup_2_provider", "Test Ngroup 2 Provider", True, test_admin_user.id, ngroup_id=ngroup2["id"])
