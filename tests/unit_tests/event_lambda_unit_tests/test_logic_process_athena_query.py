...
from app.event_lambdas.process_athena_query.logic import (store_result_in_s3, get_query_results_as_json,
                                                          parse_csv_to_json, get_query_error_reason, QueryProcessingError)

@pytest.mark.asyncio
async def test_get_query_results_as_json(mock_boto3_client):
    """Test getting query results as JSON."""
...
async def test_get_query_results_as_json_clienterror(mock_boto3_client):
    """Test getting query results as json, but athena client fails to get query execution."""
...
async def test_parse_csv_to_json(mock_boto3_client):
    """Test parsing CSV to JSON"""
    data  = [["field1","field2","field3"],
             ["value1_1","","value1_3"],
             ["value1_2","value2_2","value2_3"],
    ...
    expected_json = [{"field1":"value1_1", "field2":None, "field3": "value1_3"},
                     {"field1":"value1_2", "field2":"value2_2", "field3": "value2_3"},
...
async def test_get_query_error_reason(mock_boto3_client):
    """Test getting query error reason"""
    mock_query_execution_id = str(uuid.uuid4())
...
async def test_get_query_error_reason_clienterror(mock_boto3_client):
    """Test getting query error reason, but athena client fails to get query execution."""
    athena = mock_boto3_client("athena")
    athena.get_query_execution.side_effect = ClientError({"Error":{"Message":"Forced Error", "Code":"get_query_execution.failed"}},
...
async def test_store_result_in_s3(mock_boto3_client):
    """Test storing result in s3 bucket."""
    mock_query_execution_id = str(uuid.uuid4())
...
async def test_store_result_in_s3_clienterror(mock_boto3_client):
    """Test storing result in s3 bucket, but there s3 client fails to put put object"""
